(function () {
	...
	var app = angular.module('custom-zifour-app',['service']);
	...
	app.controller('custom-zifour-controller',['$scope','$http','erp','$routeParams','$compile','$timeout',function ($scope,$http,erp,$routeParams,$compile,$timeout) {
		...
		function getDisputeCount(){
			var sendData ={"status":"7","ydh":"all","disputeId":"dispute","id":"","page":1,"limit":100,"trackingnumberType":"all","cjOrderDateBegin":"","cjOrderDateEnd":"","orderNumber":"","shopName":"","sku":"","cjProductName":"","consumerName":"","salesmanName":"","shipmentsOrderId":"","customerName":"","split":""};
