...
/** 这句话千万不要动！！！，打包项目时添加构建日期 */
window.BUILD_VERSION = null;
(function(){
  document.write("<script type='text/javascript' src='/static/js/public/config.js'></script>")
})()
app.service('erp', ['$http','$q', function ($http,$q) {
  ...
  if (
    ...
    // 国内阿里云代理服务器
    httpsJson = window.PROXY['production']
  }
  // 之前production配置
  // httpsJson = {
