(function () {
	var app = angular.module('excel-order-app',['service']);
	app.controller('excel-ctroller',['$scope','erp',function ($scope,erp) {
		...
		$('.order-view').click(function () {
			...
			//控制点击对应的内容显示
			var indexView = $('.order-view').index(this);
			console.log(indexView)
			$('.toggle-delord-div').hide();
			$('.toggle-delord-div').eq(indexView).show();
		})
