(function () {
	var app = angular.module('excel-cl-app',['service']);
	app.controller('excel-cl-ctroller',['$scope','erp',function ($scope,erp) {
		...
		// })
		//excel订单状态处理
		$('.exc-sta-a').click(function () {
			$('.exc-sta-a').removeClass('active-a');
