(function () {
	...
	var app = angular.module('custom-muclz-app',['service']);
	app.controller('custom-muclz-controller',['$scope','$http','erp',function ($scope,$http,erp) {
		console.log('处理中')
		var bs = new Base64();
		var that =this;
		...
		$scope.classMoney=function(money){
